...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Nexus² — AI concierge for any website" },
      { property: "og:description", content: "An AI-powered chat and voice agent that helps visitors navigate your site." },
